...
**启动子区域的tetO序列**结合来抑制抗性蛋白的转录。Tet与TetR结合使TetR对tetO序列的亲和力降低9个数量级，使耐药蛋白表达。在真核细胞中，将单纯疱疹病毒VP16反式激活蛋白的激活结构域与tetR融合，产生了强的真核转录激活因子。为了促进结合特异性，将tetO多聚化嵌入真核生物最小启动子，创建了Tet诱导基因表达系统。
