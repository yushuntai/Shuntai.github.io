...
Expression dataset里面是否是  **GSEA [4896x6 (ann: 4896,6,chip na)]**  <br>
Gene sets database 软件自带的数据库，包括GO/KEGG/wikipathway等等，可以几个数据库都试试，看能不能富集到一些有用信息，也可以自己新建gene set然后导入。<br>
...
Basic fields 里面 Min size: exclude smaller sets 我调整为1才跑的动
