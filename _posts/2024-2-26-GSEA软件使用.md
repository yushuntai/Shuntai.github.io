...
点Phenotype labels——Create an on-the-fly Phenotype——填写好信息（要和.txt文件中的对应）如所示——Apply to dataset——出现成功提示后点确定再close——点中的Show phenotypes from all source files——选中阴影处——OK
