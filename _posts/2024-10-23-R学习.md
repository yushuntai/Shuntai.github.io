...
# 读取雷达图数据文件
gene1 <- c(130.4, 1392.7, 1330, 763.4, 310.8, 158.4)
gene2 <- c(142.9, 136.4, 118.1, 200, 20.3, 16.8)
gene3 <- c(1392.7, 129.4, 136.9, 63.4, 55.3, 25.1)
gene4 <- c(2156.7, 2050.9, 1953.7, 1059.3, 657.9, 387.8)

df <- data.frame(gene1=gene1, gene2=gene2, gene3=gene3, gene4=gene4)
df <- t(df)   #转置，使行变成列，列变成行。
